...
pdf("tiffin_mtruncatula_scatter.pdf", height = 14, width = 14)
par(mfrow = c(7, 3), mar=c(4,4,4,4), cex.axis=0.7, cex.lab=1, cex.main=1, cex.sub=1,mgp=c(2,1,0) )
lapply(names(my_list), function(x){
return(plot(-log10(as.numeric(my_list[[x]]$min_sdP_DS)),-log10(my_list[[x]]$dunnsidak_orthopvalues), xlab="WZA_ortho_p", ylab="SweeD_ortho_p", main = x))
})
...
my_list <- llist(annual_precip, max_temp_warmest_month, mean_diurnal, mean_temp, mean_temp_cold_quarter, mean_temp_dry_quarter, mean_temp_warm_quarter, mean_temp_wet_quarter, min_temp_coldest_month, prec_clim_change,precip_cold_quarter,precip_dry_month,precip_dry_quarter,precip_seasonality,precip_warm_quarter,precip_wet_month,precip_wet_quarter,temp_range,temp_seasonality,tmax_clim_change)

pdf("murray_emag_scatter.pdf", height = 14, width = 14)
par(mfrow = c(7, 3), mar=c(4,4,4,4), cex.axis=0.7, cex.lab=1, cex.main=1, cex.sub=1,mgp=c(2,1,0) )
lapply(names(my_list), function(x){
return(plot(-log10(as.numeric(my_list[[x]]$min_sdP_DS)),-log10(my_list[[x]]$dunnsidak_orthopvalues), xlab="WZA_ortho_p", ylab="SweeD_ortho_p", main = x))
})
...
pdf("todesco_hann_scatter.pdf", height = 14, width = 14)
par(mfrow = c(7, 3), mar=c(4,4,4,4), cex.axis=0.7, cex.lab=1, cex.main=1, cex.sub=1,mgp=c(2,1,0) )
lapply(names(my_list), function(x){
return(plot(-log10(as.numeric(my_list[[x]]$min_sdP_DS)),-log10(my_list[[x]]$dunnsidak_orthopvalues), xlab="WZA_ortho_p", ylab="SweeD_ortho_p", main = x))
})
...
pdf("todesco_hpet_scatter.pdf", height = 14, width = 14)
par(mfrow = c(7, 3), mar=c(4,4,4,4), cex.axis=0.7, cex.lab=1, cex.main=1, cex.sub=1,mgp=c(2,1,0) )
lapply(names(my_list), function(x){
return(plot(-log10(as.numeric(my_list[[x]]$min_sdP_DS)),-log10(my_list[[x]]$dunnsidak_orthopvalues), xlab="WZA_ortho_p", ylab="SweeD_ortho_p", main = x))
})
...
pdf("todesco_hargo_scatter.pdf", height = 14, width = 14)
par(mfrow = c(7, 3), mar=c(4,4,4,4), cex.axis=0.7, cex.lab=1, cex.main=1, cex.sub=1,mgp=c(2,1,0) )
lapply(names(my_list), function(x){
return(plot(-log10(as.numeric(my_list[[x]]$min_sdP_DS)),-log10(my_list[[x]]$dunnsidak_orthopvalues), xlab="WZA_ortho_p", ylab="SweeD_ortho_p", main = x))
})
...
pdf("ingvarsson_ptremula_scatter.pdf", height = 14, width = 14)
par(mfrow = c(7, 3), mar=c(4,4,4,4), cex.axis=0.7, cex.lab=1, cex.main=1, cex.sub=1,mgp=c(2,1,0) )
lapply(names(my_list), function(x){
    return(plot(-log10(as.numeric(my_list[[x]]$min_sdP_DS)),-log10(my_list[[x]]$dunnsidak_orthopvalues), xlab="WZA_ortho_p", ylab="SweeD_ortho_p", main = x))
})
